...
def NewVerticalFrameInstanceBigWin(Document, TypeName, LocationKey, EndRefPlane, MirrorBoolean):
...
def NewHorizontalFrameInstanceBigWin(Document, TypeName, LocationKey, EndRefPlane, MirrorBoolean):
