...
def InsertionPoints(Document, Location):

    listverticalplanes = ("A", "B", "C", "D", "E", "F", "G", "H")
    ...
    listhorizontalplanes = ("1a", "1b", "1c", "1d")
    ...
    intviewlisthorizontalplanes = ("1", "2", "3", "4","5", "6", "7")
    ...
    ################
    return ptsdi[Location] 



def ReferencePlanes(Document, Plane):
    ...
    ################
    return refplanedi[Plane]

def NewVerticalProfileInstace(Document, TypeName, LocationXYZ, EndRefPlane, MirrorBoolean):
